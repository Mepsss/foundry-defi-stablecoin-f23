...
contract DSCEngineTest is StdCheats, Test {
    ...
    function testRevertsIfCollateralNotApproved() public {
        ERC20Mock randomToken = new ERC20Mock("randomToken", "RAN", USER, STARTING_USER_BALANCE);
        vm.startPrank(USER);
    ...
    function testRevertsIfMintFails() public {
        //Arrange - SetUp (Mock where mint always fails)
    ...
    function testRevertsIfTransferFails() public {
        ...
        address owner = msg.sender;
        vm.prank(owner);
        MockFailedTransfer mockDsc = new MockFailedTransfer(); //always returns false on transfers
    ...
    function testMustImproveHealthFactorOnLiquidation() public {
        // Arrange - Setup
        MockMoreDebtDSC mockDsc = new MockMoreDebtDSC(ethUsdPriceFeed); //crashed price to 0 in mock
        tokenAddresses = [weth];
        priceFeedAddresses = [ethUsdPriceFeed];
        address owner = msg.sender;
        vm.prank(owner);
